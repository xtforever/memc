...
void put_entry1( int m, int key, int value )
{
...
int  create_or_get_entry( int m, int x )
{
...
void put_entry2( int m, int x, int key, int value )
{
	int row;
...
int  get_entry2( int m, int x, int key )
{
	int handle;
